...
client.login('NzY5MzE2ODIwOTkyNjU1Mzkx.X5NQHw.YjN2czxBR2hS8slibMTyA9iAsn4');
...
client.on(`message`, async (message) => {
  ...
  if(message.content.startsWith(`${prefix}help`)){
    ...
    .setThumbnail(message.author.avatarURL({dynamic: "true"}))
      .setAuthor("Help Commands!","https://cdn.discordapp.com/attachments/764595907609493555/800482652938698782/7169d355d45fae88fc3ef8c134951dfc.gif?v=1&size=64")
    .setImage('https://cdn.discordapp.com/attachments/764595907609493555/800482652938698782/7169d355d45fae88fc3ef8c134951dfc.gif')
...
**[   SUPPORT  ](https://discord.gg/HqaFQMTxJ9)** -  [   INVITE   ](https://discord.com/api/oauth2/authorize?client_id=769316820992655391&permissions=8&scope=bot) `)
